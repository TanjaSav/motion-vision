...
//   return (
//     <section ref={ref} className="relative overflow-hidden px-24 sm:px-20">
//       {/* Hero background */}
...
//   return (
//     <section className="relative overflow-hidden py-30 sm:py-26 px-24 sm:px-20">
//       {/* Soft section glow */}
...
//   return (
//     <section className="relative overflow-hidden pb-24 sm:pb-20 px-24 sm:px-20">
//       {/* Soft section glow */}
//       <div className="pointer-events-none " />

//       {/* Shared page container */}
//       <div className="relative z-10 mx-auto w-full max-w-[1440px] px-4 sm:px-2 ">
//         {/* Section heading */}
//         <motion.div
//           initial={{ opacity: 0, y: 30, filter: "blur(8px)" }}
//           whileInView={{ opacity: 1, y: 0, filter: "blur(0px)" }}
...
function HeroSection() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden py-24 sm:py-28 lg:py-32">
      {/* Hero background */}
      <div className="absolute inset-0 bg-linear-to-b from-[#0a0a0a] via-[#223a70]/20 to-[#0a0a0a]" />
